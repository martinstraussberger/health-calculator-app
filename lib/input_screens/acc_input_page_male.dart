...
import 'package:your_healthcalculators/calculate_acc_men.dart';
import 'package:your_healthcalculators/screens/results_acc_men.dart';

class AccInputPageMale extends StatefulWidget {
  @override
  _AccInputPageMaleState createState() => _AccInputPageMaleState();
}

class _AccInputPageMaleState extends State<AccInputPageMale> {
  bool ex1 = false;
  bool ex2 = false;
  bool ex3 = false;
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                BottomButton(
                  ...
                  onTap: () {
                    //from function
                    CalculateAccMen calc = CalculateAccMen(
                        height: height,
                        weight: weight,
                        age: age,
                        ex1: ex1,
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AccResultPageMen(
                          accResultMen: calc.calculateActiveCaloricNeed(),

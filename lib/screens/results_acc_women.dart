...
class AccResultPageWomen extends StatelessWidget {
  AccResultPageWomen({
    @required this.accResultWomen,
    @required this.resultText,
  });

  final String accResultWomen;
                ...
                child: ResultCard(
                  ...
                  cardChild: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        accResultWomen + 'kcal/day',
                        style: kNumbersStyle,
                      ),
                      Text(
                        'To grasp a bigger picture:',
